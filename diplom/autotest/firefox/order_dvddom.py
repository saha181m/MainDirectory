...
@allure.story("Тест оформления заказа Firefox_allure")
@allure.title("Тест оформления заказа Firefox_allure")
def test_order(browser_data:webdriver.Firefox, act:ActionChains):
    ...
    # browser_data.save_screenshot('/Diplom/Firefox/order1.png')
    sleep(5)
    ...
    with allure.step('Делаем скриншот'):
        allure.attach(browser_data.get_screenshot_as_png(), name='order2',
                          attachment_type=AttachmentType.PNG)
    # browser_data.save_screenshot('/Diplom/Firefox/order2.png')
    sleep(5)
    with allure.step('Нажатие на кнопку "Оформить заказ"'):
        order=browser_data.find_element(By.NAME,'checkout')
    ...
    with allure.step('Делаем скриншот'):
        allure.attach(browser_data.get_screenshot_as_png(), name='order3',
                      attachment_type=AttachmentType.PNG)
    # browser_data.save_screenshot('/Diplom/Firefox/order3.png')
    ...
    with allure.step('Делаем скриншот'):
        allure.attach(browser_data.get_screenshot_as_png(), name='order4',
                      attachment_type=AttachmentType.PNG)
    # browser_data.save_screenshot('/Diplom/Firefox/order4.png')
    sleep(5)
    ...
    with allure.step('Делаем скриншот'):
        allure.attach(browser_data.get_screenshot_as_png(), name='order5',
                      attachment_type=AttachmentType.PNG)
    # browser_data.save_screenshot('/Diplom/Firefox/order5.png')
    sleep(5)
    ...
    with allure.step('Делаем скриншот'):
        allure.attach(browser_data.get_screenshot_as_png(), name='order6',
                      attachment_type=AttachmentType.PNG)
    # browser_data.save_screenshot('/Diplom/Firefox/order6.png')
    sleep(5)
    ...
    with allure.step('Делаем скриншот'):
        allure.attach(browser_data.get_screenshot_as_png(), name='order7',
                      attachment_type=AttachmentType.PNG)
    # browser_data.save_screenshot('/Diplom/Firefox/order7.png')
    sleep(10)
