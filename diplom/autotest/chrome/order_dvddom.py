...
@allure.story("Тест оформления заказа Chrome_allure")
@allure.title("Тест оформления заказа Chrome_allure")
def test_order(browser_data:webdriver.Chrome, act:ActionChains):
    with allure.step('Авторизация на сайте'):
        ...
        act.perform()
        sleep(5)
        email = browser_data.find_element(By.XPATH,
                                          "/html/body/div[4]/div[2]/div/div[2]/div/div[2]/div[1]/div[2]/input")
        act.move_to_element(email)
        act.click()
        act.perform()
        email.send_keys('amvrosi61@example.net')
        password = browser_data.find_element(By.XPATH,
                                             "/html/body/div[4]/div[2]/div/div[2]/div/div[2]/div[2]/div[2]/input")
    ...
    with allure.step('Выбор товара'):
        product = browser_data.find_element(By.XPATH,
                                            '/html/body/main/div/div/div/section[1]/ul/li[4]/div/div[1]/a/div/div[2]')
        act.move_to_element(product)
        act.click()
        act.perform()
        sleep(10)
        add_product = browser_data.find_element(By.XPATH,
                                                '/html/body/div[4]/div[2]/div/div/div[2]/form/div[4]/div/div[2]/div[1]/div[2]/input')
    ...
    with allure.step('Заполнение формы "Контактная информация"'):
        order_name = browser_data.find_element(By.XPATH,
                                               '/html/body/main/div/div/div/div/div[1]/form/div[2]/div[1]/div/div/div[1]/div[2]/input')
        act.move_to_element(order_name)
        act.double_click()
        act.perform()
        order_name.send_keys('Ярослав')
        sleep(5)
        order_last_name = browser_data.find_element(By.XPATH,
                                                    '/html/body/main/div/div/div/div/div[1]/form/div[2]/div[1]/div/div/div[2]/div[2]/input')
        ...
        sleep(5)
        order_region = Select(browser_data.find_element(By.XPATH,
                                                        '/html/body/main/div/div/div/div/div[1]/form/div[2]/div[1]/div/div/div[5]/div[2]/p/span[2]/select'))
    ...
    with allure.step('Нажатие на кнопку "Далее"'):
        order_button = browser_data.find_element(By.XPATH,
                                                 '/html/body/main/div/div/div/div/div[1]/form/div[2]/input[2]')
        act.move_to_element(order_button)
        act.click()
        act.perform()
        order_button_cont = browser_data.find_element(By.XPATH,
                                                      '/html/body/main/div/div/div/div/div[1]/form/div[2]/input[2]')
    ...
    with allure.step('Выбор чекбокса в разделе "Доставка"'):
        checkbox = browser_data.find_element(By.CSS_SELECTOR,
                                             '#page-content > div > div.checkout-step.step-shipping > form > div > div.checkout-content > ul > li.shipping-34 > h3 > label > span.at-stylize-box')
        act.move_to_element(checkbox)
        act.click()
        act.perform()
        order_cont = browser_data.find_element(By.CSS_SELECTOR,
                                               '#page-content > div > div.checkout-step.step-shipping > form > div > input[type=submit]:nth-child(4)')
    ...
    with allure.step('Выбор чекбокса в разделе "Оплата"'):
        checkbox2 = browser_data.find_element(By.XPATH,
                                              '/html/body/main/div/div/div/div/div[3]/form/div/div[1]/ul/li[2]/h3/label/span[1]')
    ...
    sleep(5)
    order_button_pay = browser_data.find_element(By.CSS_SELECTOR,
                                                 '#page-content > div > div.checkout-step.step-payment > form > div > input[type=submit]:nth-child(4)')
    act.move_to_element(order_button_pay)
    act.click()
    act.perform()
    sleep(5)
    with allure.step('Подтверждение заказа'):
        order_button_final = browser_data.find_element(By.XPATH,
                                                       '/html/body/main/div/div/div/div/div[4]/form/div/div[3]/input')
