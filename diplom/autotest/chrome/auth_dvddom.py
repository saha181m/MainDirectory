...
@allure.story("Регистрация на сайте Chrome_allure")
@allure.title("Регистрация на сайте Chrome_allure")
def test_auth(browser_data: webdriver.Chrome):
    ...
    # browser_data.save_screenshot('/Diplom/Chrome_allure/auth1.png')
    with allure.step('Нажатие на кнопку "Регистрация"'):
    ...
    with allure.step('Делаем скриншот'):
        allure.attach(browser_data.get_screenshot_as_png(), name='auth2',
                      attachment_type=AttachmentType.PNG)
    # browser_data.save_screenshot('/Diplom/Chrome_allure/auth2.png')
    ...
    with allure.step('Делаем скриншот'):
        allure.attach(browser_data.get_screenshot_as_png(), name='auth3',
                      attachment_type=AttachmentType.PNG)
    # browser_data.save_screenshot('/Diplom/Chrome_allure/auth3.png')
