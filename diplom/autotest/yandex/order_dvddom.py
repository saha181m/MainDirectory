...
@allure.story("Тест оформления заказа Yandex_allure")
@allure.title("Тест оформления заказа Yandex_allure")
def test_order(browser_data:webdriver.Chrome, act:ActionChains):
    ...
    # browser_data.save_screenshot('/Diplom/Yandex/order1.png')
    sleep(5)
    ...
    with allure.step('Делаем скриншот'):
        allure.attach(browser_data.get_screenshot_as_png(), name='order2',
                          attachment_type=AttachmentType.PNG)
    # browser_data.save_screenshot('/Diplom/Yandex/order2.png')
    sleep(5)
    ...
    with allure.step('Делаем скриншот'):
        allure.attach(browser_data.get_screenshot_as_png(), name='order3',
                      attachment_type=AttachmentType.PNG)
    # browser_data.save_screenshot('/Diplom/Yandex/order3.png')
    ...
    with allure.step('Делаем скриншот'):
        allure.attach(browser_data.get_screenshot_as_png(), name='order4',
                      attachment_type=AttachmentType.PNG)
    # browser_data.save_screenshot('/Diplom/Yandex/order4.png')
    sleep(5)
    ...
    with allure.step('Делаем скриншот'):
        allure.attach(browser_data.get_screenshot_as_png(), name='order5',
                      attachment_type=AttachmentType.PNG)
    # browser_data.save_screenshot('/Diplom/Yandex/order5.png')
    sleep(5)
    ...
    with allure.step('Делаем скриншот'):
        allure.attach(browser_data.get_screenshot_as_png(), name='order6',
                      attachment_type=AttachmentType.PNG)
    # browser_data.save_screenshot('/Diplom/Yandex/order6.png')
    sleep(5)
    ...
    with allure.step('Делаем скриншот'):
        allure.attach(browser_data.get_screenshot_as_png(), name='order7',
                      attachment_type=AttachmentType.PNG)
    # browser_data.save_screenshot('/Diplom/Yandex/order7.png')
    sleep(10)
