...
@allure.story("Регистрация на сайте Edge_allure")
@allure.title("Регистрация на сайте Edge_allure")
def test_auth(browser_data: webdriver.Edge):
    ...
    # browser_data.save_screenshot('/Diplom/Edge_allure/auth1.png')
    with allure.step('Нажатие на кнопку "Регистрация"'):
    ...
    with allure.step('Делаем скриншот'):
        allure.attach(browser_data.get_screenshot_as_png(), name='auth2',
                      attachment_type=AttachmentType.PNG)
    # browser_data.save_screenshot('/Diplom/Edge_allure/auth2.png')
    sleep(2)
    ...
    with allure.step('Делаем скриншот'):
        allure.attach(browser_data.get_screenshot_as_png(), name='auth3',
                      attachment_type=AttachmentType.PNG)
    # browser_data.save_screenshot('/Diplom/Edge_allure/auth3.png')
