...
@allure.story("Добавление заказа в корзину Edge_allure")
@allure.title("Добавление заказа в корзину Edge_allure")
def test_add_cart(browser_data:webdriver.Edge,act:ActionChains):
    ...
    with allure.step('Делаем скриншот'):
        ...
        # browser_data.save_screenshot('/Diplom/Edge_allure/adding_to_cart1.png')
    ...
    with allure.step('Делаем скриншот'):
        allure.attach(browser_data.get_screenshot_as_png(), name='adding_to_cart2',
                      attachment_type=AttachmentType.PNG)
    # browser_data.save_screenshot('/Diplom/Edge_allure/adding_to_cart2.png')
    ...
    with allure.step('Делаем скриншот'):
        allure.attach(browser_data.get_screenshot_as_png(), name='adding_to_cart3',
                      attachment_type=AttachmentType.PNG)
    # browser_data.save_screenshot('/Diplom/Edge_allure/adding_to_cart3.png')
    ...
    with allure.step('Делаем скриншот'):
        allure.attach(browser_data.get_screenshot_as_png(), name='adding_to_cart4',
                      attachment_type=AttachmentType.PNG)
    # browser_data.save_screenshot('/Diplom/Edge_allure/adding_to_cart4.png')
